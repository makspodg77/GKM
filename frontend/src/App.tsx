  ...
  return (
    <>
      ...
      <section className="menu">
        Rozklady jazdy
        <ul>
          <li><Link to="/rozklad-jazdy-wedlug-linii">Rozkłady jazdy według linii</Link></li>
  ...
  return (
    <Router>
        <Routes>
          ...
          <Route path="/" element={<PageStructure><>doris</></PageStructure>} />
          <Route path="/linie" element={<PageStructure><TransportLines /></PageStructure>} />
          <Route path="/rozklad-jazdy-wedlug-linii" element={<PageStructure><LinesTimeTable /></PageStructure>} />
          <Route path="/rozklad-jazdy-wedlug-linii/:lineId" element={<PageStructure><LineTimetable /></PageStructure>} />
          <Route path="/rozklad-jazdy-wedlug-linii/:lineId/:stopId/:routeId" element={<PageStructure><LineStopTimetable /></PageStructure>} />
          <Route path="*" element={<>404 Nie znaleziono doris</>} />
          <Route path="/zespol-przystankowy/:stopId" element={<PageStructure><StopGroup /></PageStructure>} />
          <Route path="/rozklad-jazdy-wedlug-linii/kurs/:timetableId/:stopId" element={<PageStructure><LineRoute /></PageStructure>} />
        </Routes>
    </Router>
  )
};
